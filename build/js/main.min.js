...
$(function(){function o(){var o=$(this).scrollTop(),i=$(".top"),n=$(".navbar-brand"),t=$(window).height(),a=$(document).height(),e=a-t-292,l=o/e*100-292/e*100+"%";o>0?i.addClass("visible"):i.removeClass("visible"),o>=232?n.addClass("visible"):n.removeClass("visible"),$(".progressbar").width(l)}$("body").scrollspy({target:".navbar-collapse"}).flowtype({minimum:320,maximum:780,minFont:12,maxFont:16}),$('[data-toggle="popover"]').popover({html:!0}),$(document).on("click","#main-navigation li a, .top, .navbar-brand, .overview-links a",function(){var o=$(this).attr("href"),i=-8;return $("html, body").animate({scrollTop:$(o).offset().top+i},{duration:500}),!1}),$(document).on("click",".nav a",function(){$(window).width()<=800&&$(".navbar-toggle").click()}),o(),$(window).scroll(function(){o()}),$(document).on("click",".show-source",function(){$("pre code").each(function(o,i){hljs.highlightBlock(i)})})});