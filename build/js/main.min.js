...
$(function(){$("body").scrollspy({target:".navbar-collapse"}).flowtype({minimum:320,maximum:780,minFont:12,maxFont:16}),$(document).on("click","#main-navigation li a, .top, .navbar-brand",function(){var n=$(this).attr("href"),t=-9;return $("html, body").animate({scrollTop:$(n).offset().top+t},{duration:1e3}),!1})});