...
$(function(){function o(){var o=$(".top");$(this).scrollTop()>0?o.addClass("visible"):o.removeClass("visible")}$("body").scrollspy({target:".navbar-collapse"}).flowtype({minimum:320,maximum:780,minFont:12,maxFont:16}),$('[data-toggle="popover"]').popover({html:!0}),$(document).on("click","#main-navigation li a, .top, .navbar-brand, .overview-links a",function(){var o=$(this).attr("href"),n=-9;return $("html, body").animate({scrollTop:$(o).offset().top+n},{duration:500}),!1}),o(),$(window).scroll(function(){o()}),$(document).on("click",".show-source",function(){$("pre code").each(function(o,n){hljs.highlightBlock(n)})})});