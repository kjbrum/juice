...
$(function(){function o(){var o=$(".top"),i=$(".navbar-brand");$(this).scrollTop()>0?o.addClass("visible"):o.removeClass("visible"),$(this).scrollTop()>=232?i.addClass("visible"):i.removeClass("visible")}$("body").scrollspy({target:".navbar-collapse"}).flowtype({minimum:320,maximum:780,minFont:12,maxFont:16}),$('[data-toggle="popover"]').popover({html:!0}),$(document).on("click","#main-navigation li a, .top, .navbar-brand, .overview-links a",function(){var o=$(this).attr("href"),i=-9;return $("html, body").animate({scrollTop:$(o).offset().top+i},{duration:500}),!1}),o(),$(window).scroll(function(){o()}),$(document).on("click",".show-source",function(){$("pre code").each(function(o,i){hljs.highlightBlock(i)})})});